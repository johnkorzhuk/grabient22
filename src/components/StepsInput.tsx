  ...
  return (
    ...
    >
      <PopoverTrigger asChild>
        <div
          className="flex items-center field-sizing-content min-w-[70px] relative border border-input rounded-md h-9 bg-background hover:bg-accent hover:text-accent-foreground transition-colors"
          onClick={(e) => {
        ...
        >
          <input
            ...
            className={cn(
              'h-full px-3 py-2 text-sm rounded-md',
              'bg-transparent',
      ...
      <PopoverContent
        className="w-[--radix-popover-trigger-width] min-w-[80px] p-0"
        align="start"
        side="bottom"
        sideOffset={0}
        alignOffset={0}
