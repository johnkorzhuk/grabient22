  ...
  const onChannelOrderChange = (
    ...
    if (collectionIndex !== -1) {
      ...
      updatedCollections[collectionIndex] = {
        ...
        likes:
          newSeed !== initialCollection?.seed
            ? 0
            : initialCollection?.likes || 0,
      }
  ...
  return (
    <section className="h-full w-full relative">
      ...
      >
                  ...
                  <Link
                    ...
                    search={(search) => {
                      return {
                        ...search,
                        angle:
                          angle === 'auto' ? collection.angle : search.angle,
                        style:
                          style === 'auto' ? collection.style : search.style,
                        steps:
                          steps === 'auto' ? collection.steps : search.steps,
                      }
                    }}
        ...
        {isLoading && (
          <>
            {Array.from({ length: DEFAULT_COLLECTION_PAGE_SIZE }).map(
              (_, index) => (
